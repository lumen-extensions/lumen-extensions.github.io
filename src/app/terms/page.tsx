          ...
          <div className="policy-content bg-white rounded-lg shadow-sm p-8">
            ...
            <div className="prose prose-lg max-w-none" style={{ fontSize: "17px", lineHeight: "1.7" }}>
              ...
              <section className="mb-8">
                ...
                <h3 className="text-lg font-medium extension-text mb-3">Invoice Generator & Maker Specific Terms</h3>
                <p className="text-gray-700 mb-4">
                  When using the Invoice Generator & Maker extension, you additionally agree to:
                </p>
                <ul className="list-disc pl-6 mb-4 text-gray-700 space-y-2">
                  <li><strong>Financial Accuracy:</strong> You are solely responsible for the accuracy of all financial calculations, tax calculations, and invoice data generated using the extension.</li>
                  <li><strong>Tax Compliance:</strong> You acknowledge that you are responsible for ensuring compliance with all applicable tax laws and regulations in your jurisdiction.</li>
                  <li><strong>Data Backup:</strong> You are responsible for backing up your invoice data. We are not liable for any loss of data due to device failure, browser issues, or other technical problems.</li>
                  <li><strong>Professional Use:</strong> If using the extension for professional or commercial purposes, you must ensure compliance with all applicable business regulations and professional standards.</li>
                  <li><strong>Client Data:</strong> You are responsible for obtaining proper consent and ensuring compliance with privacy laws when collecting and processing client information through the extension.</li>
                </ul>
              </section>
              ...
              <section className="mb-8">
                ...
                <h3 className="text-lg font-medium extension-text mb-3">Financial Data and Invoice Liability</h3>
                <p className="text-gray-700 mb-4">
                  For the Invoice Generator & Maker extension specifically, we disclaim liability for:
                </p>
                <ul className="list-disc pl-6 mb-4 text-gray-700 space-y-2">
                  <li><strong>Financial Accuracy:</strong> Any errors in tax calculations, financial computations, or invoice formatting.</li>
                  <li><strong>Data Loss:</strong> Loss of invoice data due to browser issues, device failure, or user error.</li>
                  <li><strong>Tax Compliance:</strong> Any penalties, fines, or legal issues arising from incorrect tax calculations or non-compliance with tax regulations.</li>
                  <li><strong>Business Decisions:</strong> Any business decisions made based on invoices or financial data generated by the extension.</li>
                  <li><strong>Third-Party Integration:</strong> Issues arising from integration with accounting software, payment processors, or other third-party services.</li>
                </ul>
                <p className="text-gray-700">
              ...
              <section className="mb-8">
                <h2 className="text-xl font-semibold extension-text mb-4">10. LEGAL COMPLIANCE AND DISCLAIMERS</h2>
                
                <h3 className="text-lg font-medium extension-text mb-3">Service Disclaimers</h3>
                <p className="text-gray-700 mb-4">
                  The Services are provided "as-is" and "as-available" with the following disclaimers:
                </p>
                <ul className="list-disc pl-6 mb-4 text-gray-700 space-y-2">
                  <li><strong>No Legal Advice:</strong> The Services do not provide legal, tax, or financial advice. You are responsible for consulting with qualified professionals.</li>
                  <li><strong>No Warranties:</strong> We make no warranties about the accuracy, reliability, or completeness of the Services.</li>
                  <li><strong>User Responsibility:</strong> You use the Services at your own risk and are responsible for verifying all outputs.</li>
                  <li><strong>Compliance Responsibility:</strong> You are solely responsible for ensuring compliance with all applicable laws and regulations in your jurisdiction.</li>
                </ul>

                <h3 className="text-lg font-medium extension-text mb-3">Data Privacy</h3>
                <p className="text-gray-700 mb-4">
                  Regarding data privacy and GDPR/CCPA compliance:
                </p>
                <ul className="list-disc pl-6 mb-4 text-gray-700 space-y-2">
                  <li><strong>Local Storage Only:</strong> All invoice data is stored locally on your device and is not transmitted to our servers.</li>
                  <li><strong>No Data Collection:</strong> We do not collect, store, or process personal data on our servers.</li>
                  <li><strong>User Control:</strong> You have complete control over your data and can delete it at any time through your browser settings.</li>
                </ul>

                <h3 className="text-lg font-medium extension-text mb-3">Intellectual Property</h3>
                <p className="text-gray-700 mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-xl font-semibold extension-text mb-4">11. MISCELLANEOUS</h2>
                <p className="text-gray-700 mb-4">
